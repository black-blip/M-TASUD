...
from app.utils.diarizer import audio_preprocessing
...
class VoiceEncoder(nn.Module):
    def __init__(self, device: Union[str, torch.device]=None, verbose=True):
        ...
        weights_fpath = Path(__file__).resolve().parent.joinpath("weights_large.pt")
    ...
    def embed_utterance(self, wav: np.ndarray, return_partials=False, rate=1.3, min_coverage=0.75):
        ...
        mel = audio_preprocessing.wav_to_mel_spectrogram(wav)
